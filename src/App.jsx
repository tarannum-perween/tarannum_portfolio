...
/**
 * CUSTOM ASSETS
 * SVG for the Sliding Blue Robot
 */
    ...
    <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
      <div className="z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a href="https://drive.google.com/file/d/1EyKaQP5oRp4dR0phPWJJiq9tCqLwhqN0/view?usp=sharing" target="_blank" rel="noreferrer" className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-lg text-slate-900 bg-sky-400 hover:bg-sky-500 transition-all shadow-[0_0_20px_rgba(56,189,248,0.3)]">
            Resume
          </a>
